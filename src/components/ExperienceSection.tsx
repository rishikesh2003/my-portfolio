import { workExperience, type WorkExperience } from "@/lib/data";
import TimelineItem from "./TimelineItem";
import { FileText, Trophy, Code } from "lucide-react";
  ...
  return (
      ...
      >
        <div className="container max-w-4xl mx-auto px-6 md:px-4">
          ...
          <div className="mb-8">
            {workExperience.map((job: WorkExperience, index) => (
                <TimelineItem
                ...
                >
                  ...
                  {job.summary && (
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground ml-4 pl-6">
                        {job.summary}
                      </p>
                    </motion.div>
                  )}
                  ...
                  {job.tools && job.tools.length > 0 && (
                      ...
                      >
                        ...
                        <div className="ml-4 pl-6 flex flex-wrap gap-2">
                          {job.tools.map((tool: string) => (
                            <span
                                key={tool}
                                className="text-muted-foreground px-2 py-1 text-xs rounded-full bg-purple-500/10 border border-purple-500/20"
                            >
                              {tool}
                            </span>
                        ))}
